...
markerBandeiras1.bindPopup("açí do Roberto Carlos. Bragança PA");
// Adiciona o alfinete (marker) clicável
const markerBandeiras2 = L.marker([-1.051464, -46.766250]).addTo(map);
markerBandeiras2.bindPopup("açí do Roberto Carlos. Bragança PA");
// Adiciona o alfinete (marker) clicável
const markerBandeiras3 = L.marker([-1.050398, -46.773679]).addTo(map);
markerBandeiras3.bindPopup("açí do Roberto Carlos. Bragança PA");
// Adiciona o alfinete (marker) clicável
const markerBandeiras4 = L.marker([-1.057823, -46.770246]).addTo(map);
markerBandeiras4.bindPopup("açí do Roberto Carlos. Bragança PA");

const markerBandeiras5 = L.marker([-1.051951, -46.778198]).addTo(map);
markerBandeiras5.bindPopup("açí do Roberto Carlos. Bragança PA");

const markerBandeiras6 = L.marker([-1.052239, -46.772727]).addTo(map);
markerBandeiras6.bindPopup("açí do Roberto Carlos. Bragança PA");

const markerBandeiras7 = L.marker([-1.055160, -46.770126]).addTo(map);
markerBandeiras7.bindPopup("açí do Roberto Carlos. Bragança PA");
